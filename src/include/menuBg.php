        ...
        <li class="lang">
            <ul>
                ...
                if($lang == 'fr') { ?>
                    ...
                    <a class="redirection" style="padding: 0 !important;" href="<?= $recupName ?>?lang=en">
                ...
                <?php } else { ?>
                    ...
                    <a class="redirection" style="padding: 0 !important;" href="<?= $recupName ?>?lang=fr">
